...
{
    public static unsafe bool HandleMovRm32R32(CONTEXT* ctx, byte* ip, Action<string, int> Log, bool W, bool R, bool X, bool B)
    {
    ...
    public static unsafe ulong ResolveEA_Rex(CONTEXT* ctx, byte* ip, ref int offs, byte mod, int rm, bool X, bool B, out string desc)
    {
        int rmLow = rm & 7;
        ...
        if (rmLow == 0b100)
        {
            ...
            if (baseLow == 0b101 && mod == 0b00 && !B)
            {
                ...
                offs += 4;
                ea = (ulong)(long)disp32 + indexVal * (ulong)scale;
            ...
            if (mod == 0b01)
            {
                ...
                offs += 1;
                ea = baseRegVal + (ulong)disp8 + indexVal * (ulong)scale;
            ...
            else if (mod == 0b10)
            {
                int disp32 = *(int*)(ip + offs);
                offs += 4;
                ea = baseRegVal + (ulong)disp32 + indexVal * (ulong)scale;
                desc = $"[R{baseReg}+0x{disp32:X}{indexText}]";
            }
            else
            {
                ea = baseRegVal + indexVal * (ulong)scale;
    ...
    public static unsafe bool HandleCdqe(CONTEXT* ctx, byte* ip, Action<string, int> Log, bool W, byte op2)
    {
    ...
    public static unsafe bool HandleCqo(CONTEXT* ctx, byte* ip, Action<string, int> Log, bool W, byte op2)
    {
    ...
    public static unsafe bool HandleCmpEvGv(CONTEXT* ctx, byte* ip, Action<string, int> Log, bool R, bool X, bool B, byte op2)
    {
        if (op2 != 0x39) return false;
        return HandleCmpRm64R64(ctx, ip, Log, R, X, B);
    }
    public static unsafe bool HandleCmpRm64R64(CONTEXT* ctx, byte* ip, Action<string, int> Log, bool R, bool X, bool B)
    {
    ...
    public static unsafe ulong ResolveEA64(    CONTEXT* ctx,    byte* ip,    ref int offs,    byte mod,    int rm,    bool R,    bool X,    bool B,    out string desc)
    {
        int rmLow = rm & 7;
    ...
    public static unsafe ulong GetReg64ByIndex(CONTEXT* c, int idx)
    {
        switch (idx & 15)
        {
            case 0: return c->Rax;
    ...
    public static uint UpdateFlags_Sub64(uint oldFlags, ulong a, ulong b, ulong r)
    {
    ...
    public static unsafe bool HandleCmpGvEv(CONTEXT* ctx, byte* ip, Action<string, int> Log, bool R, bool X, bool B, byte op2)
    {
        if (op2 != 0x3B) return false;
        return HandleCmpGvEv64(ctx, ip, Log);
    }
    public static unsafe bool HandlePushPopExt(CONTEXT* ctx, byte* address, Action<string, int> Log, byte op2)
    {
    ...
    public static unsafe bool HandleMovRbpRsp(CONTEXT* ctx, byte* address, Action<string, int> Log, byte op2, byte op3)
    {
    ...
    public static unsafe bool HandleSubRspImm8(CONTEXT* ctx, byte* address, Action<string, int> Log, byte op2, byte op3)
    {
    ...
    // ─────────────────────────────────────────────────────────────────────
    public static unsafe bool HandleGroup1_81(CONTEXT* ctx, byte* address, Action<string, int> Log, bool W, bool R, bool X, bool B, byte op2)
    {
    ...
    // ─────────────────────────────────────────────────────────────────────
    public static unsafe bool HandleMovImm(CONTEXT* ctx, byte* address, Action<string, int> Log, bool W, bool X, bool B, byte op2)
    {
    ...
    public static unsafe bool HandleAndRspImm8(CONTEXT* ctx, byte* address, Action<string, int> Log, byte op2, byte op3)
    {
    ...
    public static unsafe bool HandleSubRspImm32(CONTEXT* ctx, byte* address, Action<string, int> Log, byte op2, byte op3)
    {
    ...
    public static unsafe bool HandleMovRaxFromRsp(CONTEXT* ctx, byte* address, Action<string, int> Log, byte op2, byte op3)
    {
    ...
    public static unsafe bool HandleMovRm64R64(CONTEXT* ctx, byte* address, Action<string, int> Log, bool W, bool R, bool X, bool B, byte op2)
    {
    ...
    public static unsafe bool HandleGroup1_83(CONTEXT* ctx, byte* address, Action<string, int> Log, bool W, bool R, bool X, bool B, byte op2)
    {
    ...
    public static unsafe bool HandleMovR64Rm64(CONTEXT* ctx, byte* address, Action<string, int> Log, bool W, bool R, bool X, bool B, byte op2)
    {
    ...
    public static unsafe bool HandleLeaRdxRip(CONTEXT* ctx, byte* address, Action<string, int> Log, byte op2, byte op3)
    {
    ...
    public static unsafe bool HandleSubRm64R64(CONTEXT* ctx, byte* address, Action<string, int> Log, bool W, bool R, bool X, bool B, byte op2)
    {
    ...
    // 48 8D /r => LEA r64, m
    public static unsafe bool HandleLeaRm64R64(CONTEXT* ctx, byte* address, Action<string, int> Log, bool W, bool R, bool X, bool B, byte op2)
    {
    ...
    public static unsafe bool HandleAddRm64R64(CONTEXT* ctx, byte* address, Action<string, int> Log, bool W, bool R, bool X, bool B, byte op2)
    {
    ...
    public static unsafe bool HandleMovRegImm(CONTEXT* ctx, byte* address, Action<string, int> Log, byte rex, bool B, byte op2)
    {
    ...
    public static unsafe bool HandleAddRaxImm(CONTEXT* ctx, byte* address, Action<string, int> Log, bool W, byte op2)
    {
    ...
    public static unsafe bool HandleGroup5_FF(CONTEXT* ctx, byte* address, Action<string, int> Log, bool R, bool X, bool B, byte op2)
    {
    ...
    public static unsafe bool HandleTestRm64R64(CONTEXT* ctx, byte* address, Action<string, int> Log, bool W, bool R, bool X, bool B, byte op2)
    {
    ...
    public static unsafe bool HandleMovsxdRm32R64(CONTEXT* ctx, byte* address, Action<string, int> Log, byte op2)
    {
    ...
    public static unsafe bool HandleXorRm64R64(CONTEXT* ctx, byte* ip, Action<string, int> Log)
    {
    ...
    public static unsafe bool HandleCmpGvEv64(CONTEXT* ctx, byte* ip, Action<string, int> Log)
    {
