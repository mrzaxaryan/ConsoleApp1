...
{
    public static unsafe bool HandleGrp1_EwIb(CONTEXT* ctx, byte* ip, Action<string, int> Log)
    {
    ...
    public static unsafe bool HandleOperandSizePrefix(CONTEXT* ctx, byte* ip, Action<string, int> Log)
    {
    ...
    public static unsafe bool HandleCmpGvEv16(CONTEXT* ctx, byte* ip, Action<string, int> Log)
    {
    ...
    public static unsafe bool HandleCmpEvGv16(CONTEXT* ctx, byte* ip, Action<string, int> Log)
    {
    ...
    public static unsafe bool HandleTestRmR(CONTEXT* ctx, byte* ip, int operandBitsOverride, Action<string, int> Log)
    {
        int offs = 0;
    ...
    public static unsafe bool HandleMovEwGw(CONTEXT* ctx, byte* ip, Action<string, int> Log)
    {
    ...
    public static unsafe bool HandleGsPrefix(CONTEXT* ctx, byte* address, Action<string, int> Log)
    {
