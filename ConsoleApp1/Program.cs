...
unsafe class Program
{
    ...
    static void Main()
    {
        ...
        int stackSize = 1024 * 64; // you can change this dynamically

        byte[] code2 = Build(stackSize);
        //byte[] code2 = new byte[]
        //{
